...
/**
 * TDProject_Channel_Block_Category_Overview
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class TDProject_Channel_Block_Category_Overview
    ...
    public function prepareGrid() {
    	...
    	$grid = new TDProject_Core_Block_Widget_Grid($this, 'grid', 'Category');
