...
/**
 * TDProject_Channel_Model_Serializer_Release_Alpha
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class TDProject_Channel_Model_Serializer_Release_Alpha
    extends TDProject_Channel_Model_Serializer_Release_Abstract
{
     ...
     * @var string
     */
    const PCRE_REGEX = '/\/r\/(?P<packageName>\w+)\/alpha\.txt/';
    ...
    {
        // load, sort and return the alpha release's for the requested channel package
