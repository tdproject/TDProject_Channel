...
/**
 * TDProject_Channel_Model_Serializer_Release_Devel
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class TDProject_Channel_Model_Serializer_Release_Devel
     ...
     * @var string
     */
    const PCRE_REGEX = '/\/r\/(?P<packageName>\w+)\/devel\.txt/';
    ...
    {
        // load the devel release's for the requested channel package
        $releases = TDProject_Channel_Model_Utils_ReleaseUtil::getHome($this->getContainer())
            ->findAllByPackageIdFkAndStability(
    	...
    	TDProject_Channel_Model_Assembler_Channel_Api $assembler)
    {
    	...
    	// return the latest alpha release version
