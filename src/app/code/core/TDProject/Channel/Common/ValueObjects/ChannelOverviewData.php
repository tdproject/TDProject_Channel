...
/**
 * TDProject_Channel_Common_ValueObjects_ChannelOverviewData
 *
 * NOTICE OF LICENSE
 *
 ...
 * model and the controller for a channel.
 *
 * @category   	TDProject
 ...
 */
class TDProject_Channel_Common_ValueObjects_ChannelOverviewData
    extends TDProject_Channel_Common_ValueObjects_ChannelLightValue
    implements TDProject_Core_Interfaces_Block_Widget_Element_Select_Option
{
	 ...
	 */
   	...
   	public function isSelected(TechDivision_Lang_Object $value = null) {
   		return $this->getChannelId()->equals($value);
   	}
}